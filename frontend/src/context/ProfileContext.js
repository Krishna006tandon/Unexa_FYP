        ...
        console.log('📝 Profile not found, creating default profile...');
          try {
            ...
            if (user && user._id) {
              ...
              // Keep payload minimal; backend can derive required fields from auth user.
              ...
              try {
                ...
                if (
                  ...
                  // If email conflict or other validation errors, retry once with only bio.
                  await tryCreate({ bio: defaultProfileData.bio });
                }
              }
            }
          } catch (createError) {
