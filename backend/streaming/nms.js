...
function startHlsFfmpeg({ ffmpegPath, inputRtmpUrl, outputDir }) {
  ...
  const args = [
    ...
    '-preset',
    'veryfast',
    // Make HLS segments more compatible with mobile players (ExoPlayer)
    // - Align keyframes with segment boundaries (2s @ 30fps => g=60)
    '-g',
    '60',
    '-keyint_min',
    '60',
    ...
    '-level',
    '3.1',
    // Force keyframes at segment boundaries (2 seconds)
    '-force_key_frames',
